...
struct GameVersionInfo: Codable, Equatable, Identifiable {
    ...
    init(id: UUID = UUID(), gameName: String, gameIcon: String, gameVersion: String, modLoader: String, isUserAdded: Bool, createdAt: Date = Date(), lastPlayed: Date = Date(), isRunning: Bool = false) {
